...
export default function LocalSaleExpenseReport() {
    ...
    const fetchReport = async () => {
        ...
        setIsLoading(true);
        try {
            const res = await fetch(`/api/localSaleExpense/readAll?all=true&start_dat=${startDate}&end_dat=${endDate}`);
    ...
    const groupedByDate = reportData.reduce((groups, expense) => {
        const date = new Date(expense.ls_expense_date).toISOString().slice(0, 10);
    ...
    const handleExport = () => {
        ...
        exportToCSV(`Local_Sale_Expense_Report_${startDate}_to_${endDate}.csv`, headers, rows);
    };
        ...
        <div>
            <div className="group relative bg-white rounded-xl border border-gray-200 hover:border-purple-300 hover:shadow-lg transition-all duration-300 cursor-pointer overflow-hidden h-full">
                ...
                <div className="relative p-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-10">LOCAL SALE EXPENSES REPORT</h3>
                ...
                <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center">
                    <div className="bg-white rounded-lg shadow-2xl w-full max-w-5xl h-[90vh] overflow-hidden flex flex-col">
                        <div className="flex items-center justify-between p-4 border-b border-gray-300">
                            <div>
                                <h1 className="text-xl font-bold">Local Sale Expenses Report</h1>
