...
export default function ExpenseHeadPage() {
    ...
    const handleDelete = async (transactionId) => {
        ...
        try {
            const response = await fetch(
                `/api/expenseTransaction?expense_t_id=${transactionId}`,
                {
                    method: "DELETE",
                },
            );
            ...
            <Card className={"max-w-xl mx-auto"}>
                <CardContent>
                    ...
                    >
                        ...
                        <input type="hidden" {...register("transaction_type")} value="pay" />
                                        ...
                                        <CardContent className="p-4 space-y-2">
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <span className="text-sm font-medium">
                                                    {transaction.expense_t_date
                                                        ? new Date(transaction.expense_t_date).toLocaleDateString()
                                                        : "N/A"}
                                                </span>
                                            </div>
                                            <div className="flex items-center justify-between">
                                                <span className="text-xs text-gray-500">Expense Head</span>
                                                <span className="text-sm font-medium">
                                                    {transaction.account?.subhead?.subhead_nam ||
                                                        "N/A"}
                                                </span>
                                            ...
                                            <div className="flex justify-end gap-2 pt-2">
                                                ...
                                                <Button
                                                    variant="ghost"
                                                    size="sm"
                                                    onClick={() => handleDelete(transaction.expense_t_id)}
                                                >
